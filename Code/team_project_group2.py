...
def male_count(): # 計算男新生兒總數
    ...
    total_male_count_list = [] # 新增一個list裝file內的男新生兒總數
    for file_name in file_list:
        male_count_of_a_year = 0 # 新增變數用來儲存男新生兒總數
        fin = open(file_name)
        fobj = fin.readlines()
        for line in fobj:
...
def female_count(): # 計算女新生兒總數
    ...
    for file_name in file_list:
        female_count_of_a_year = 0 # 新增變數用來儲存女新生兒總數
        fin = open(file_name)
        fobj = fin.readlines()
        for line in fobj:
            string = line.split(',') # 用split切出list裡面的資料轉成str
    ...
    return total_female_count_list
...
def both_count(): # 計算新生兒總數
    ...
    for file_name in file_list:
        both_count_of_a_year = 0 # 新增變數用來儲存新生兒總數
        fin = open(file_name)
        fobj = fin.readlines()
        for line in fobj:
            string = line.split(',') # 用split切出list裡面的資料轉成str
